...
class App:
    def __init__(self, username='dataminer2060', password='WebScraper', target_username='dataminer2060',
                 path='/Users/Lazar/Desktop/instaPhotos'): #Change this to your Instagram details and desired images path
        self.username = username
        self.password = password
        self.target_username = target_username
        self.path = path
        self.driver = webdriver.Chrome('/Users/Lazar/Downloads/chromedriver') #Change this to your ChromeDriver path.
        self.error = False
